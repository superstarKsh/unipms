...
public class MG120102IVO extends CommonInVO {
	
	public String sMNG_STAGE  = "";
	public String sACTIVITY_ID  = "";
	public List<MG120102IVO_SUB> sTASK_LIST = null;
	...
	public List<MG120102IVO_SUB> getsTASK_LIST() {
		return sTASK_LIST;
	}

	public void setsTASK_LIST(List<MG120102IVO_SUB> sTASK_LIST) {
		this.sTASK_LIST = sTASK_LIST;
	}

	public static class MG120102IVO_SUB {
		public String sTASK_ID  = "";
		public String sTASK_NM  = "";
		public String sTASK_BIT  = "";
		public String sTASK_DESC  = "";
		...
		public String getsTASK_BIT() {
			return sTASK_BIT;
		}
		
		public void setsTASK_BIT(String sTASK_BIT) {
			this.sTASK_BIT = sTASK_BIT;
		}
