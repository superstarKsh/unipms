...
public class QT010101OVO extends CommonOutVO{
	...
	public String getsCNTL_TYPE_NM() {
		return sCNTL_TYPE_NM;
	}
	
	public void setsCNTL_TYPE_NM(String sCNTL_TYPE_NM) {
		this.sCNTL_TYPE_NM = sCNTL_TYPE_NM;
	}
	...
	public String getsTARGET_TYPE_NM() {
		return sTARGET_TYPE_NM;
	}
	
	public void setsTARGET_TYPE_NM(String sTARGET_TYPE_NM) {
		this.sTARGET_TYPE_NM = sTARGET_TYPE_NM;
	}
