...
function fn_InitLoad() {
	...
	fn_AjaxSend(sendData, "PJ010101", fn_SetDataInitLoad, null);
};

function fn_SetDataInitLoad(result) {
	var selCurrStage = '<option value="00">선 택</option>';
	var selBizQuater = '<option value="00">선 택</option>';
	var selBizType = '<option value="00">선 택</option>';
...
function fn_InitGrid() {
	...
	objColumnsInfo = [
		          	...
		          	fn_SetSBGridCol("04", "output"    , "sPRJT_STAGE"    , "left"  , null, true)
				];
...
function fn_CreateMnthGrid(result) {
	...
	var objGridInitInfoMmInfo = fn_InitSBGrid("mmthInfo", "objSBGridMmth", strCaption, strWidth, "75px", "objResultMmthData", true, null);
...
function fn_SelectPrjtInfo() {
	...
	fn_AjaxSend(sendData, "PJ010111", fn_SetDataSelectPrjtInfo, null);
};
...
function fn_InsertPrjt() {
	...
	fn_AjaxSend(sendData, "PJ010121", fn_SelectPrjtInfo, PMS_PROC_INSERT);
};
...
function fn_ModifyPrjtMM() {
	...
	fn_AjaxSend(sendData, "PJ010122A", fn_SetDataModifyPrjtMM, PMS_PROC_INSERT);
};
...
function fn_ModifyPrjtStage() {
	...
	fn_AjaxSend(sendData, "PJ010122B", fn_SetDataModifyPrjtStage, PMS_PROC_INSERT);
};
