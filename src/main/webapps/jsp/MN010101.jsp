...
function fn_SelectPrjtInfo() {
	...
	fn_AjaxSend(sendData, "MN010111", fn_SetDataSelectPrjtInfo, null);
};
...
function fn_SelectPrjtList() {
	...
	fn_AjaxSend(sendData, "MN010111A", fn_SetDataSelectPrjtList, null);
};
...
function fn_SelectPrjtRprt() {
	...
	fn_AjaxSend(sendData, "MN010111A", fn_SetDataSelectPrjtRprt, null);
};
