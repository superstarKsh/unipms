...
function fn_InitGrid() {
	...
	objGridInitInfo = fn_InitSBGrid("coopInfo", "objSBGrid", caption, colWidth, "500px", "resultData", true, null);
...
function fn_SelectListInfo() {
	...
	content += "&";
	content += "sSEARCH_COOP_ID="+ objSBGrid.getTextMatrix(nClickedRow,0);
	content += "&";
	content += "sSEARCH_COOP_NM="+ objSBGrid.getTextMatrix(nClickedRow,1);
	content += "&";
	
	fn_AjaxSendSesUrl(content, "pms_session_ad0301.jsp", "AD030102.jsp?p="+paramP, null);
};
