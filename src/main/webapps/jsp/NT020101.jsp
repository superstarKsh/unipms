...
function fn_SelectPrjtInfo() {
	...
	fn_AjaxSend(sendData, "NT020111", fn_SetDataSelectPrjtInfo, null);
};
...
function fn_SelectListInfo() {
	...
	if (nClickedCol == 2) {
		...
		fn_DownloadFile("NT02", downloadFile);
	} else {
		var content = "";
		content += "sSEARCH_YN=Y";
		content += "&";
		content += "sSEARCH_BOARD_SEQ_NO="+ objSBGrid.getTextMatrix(nClickedRow,0);

		fn_AjaxSendSesUrl(content, "pms_session_nt0201.jsp", "NT020103.jsp", null);
	}
};
