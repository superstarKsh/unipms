...
<%
	if ("00000000".equals(sCURR_PRJT_ID) || "".equals(sCURR_PRJT_ID) ) {
...
%>
					<li id="MTOP_HOME" class="on"><a href='MN010101.jsp'>HOME</a></li>
<%
	} else {
%>
					<li id="MTOP_HOME" class="on"><a href='MN020101.jsp'>HOME</a></li>
<%
	}
%>
...
%>
					<li id="MTOP_PJ"><a href='PJ010201.jsp'>프로젝트정보관리</a></li>
					<li id="MTOP_CS"><a href='CS010101.jsp'>CSR</a></li>
