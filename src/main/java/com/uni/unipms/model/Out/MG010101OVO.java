...
public class MG010101OVO extends CommonOutVO{
	
	private String sTASK_LEVEL = "";
	private String sTASK_ID = "";
	private String sSEQ = "";
	private String sBEFORE_SEQ = "";
	private String sUPPER_TASK_ID = "";
	private String sTASK_NM = "";
	private String sTASK_DESC = "";
	private String sBEFORE_TASK_ID = "";
	private String sSTRT_DT = "";
	private String sEND_DT = "";
	private String sPROGRESS_RT = "";
	private String sPURPOSE_RT = "";
	private String sUSER_ID = "";
	private String sOUTPUT_LIST = "";
	private String sMEMO = "";
	private String sFILE_NM = "";
	private String sIMG_URL  = "";

	public String getsTASK_LEVEL() {
		return sTASK_LEVEL;
	}

	public void setsTASK_LEVEL(String sTASK_LEVEL) {
		this.sTASK_LEVEL = sTASK_LEVEL;
	}
	...
	public String getsBEFORE_SEQ() {
		return sBEFORE_SEQ;
	}

	public void setsBEFORE_SEQ(String sBEFORE_SEQ) {
		this.sBEFORE_SEQ = sBEFORE_SEQ;
	}

	public String getsUPPER_TASK_ID() {
		return sUPPER_TASK_ID;
	}

	public void setsUPPER_TASK_ID(String sUPPER_TASK_ID) {
		this.sUPPER_TASK_ID = sUPPER_TASK_ID;
	}
	...
	public String getsBEFORE_TASK_ID() {
		return sBEFORE_TASK_ID;
	}

	public void setsBEFORE_TASK_ID(String sBEFORE_TASK_ID) {
		this.sBEFORE_TASK_ID = sBEFORE_TASK_ID;
	}
	...
	public String getsPURPOSE_RT() {
		if ("".equals(sPURPOSE_RT))
			sPURPOSE_RT = "0";
		return sPURPOSE_RT;
	}

	public void setsPURPOSE_RT(String sPURPOSE_RT) {
		this.sPURPOSE_RT = sPURPOSE_RT;
	}
	...
	public String getsOUTPUT_LIST() {
		return sOUTPUT_LIST;
	}

	public void setsOUTPUT_LIST(String sOUTPUT_LIST) {
		this.sOUTPUT_LIST = sOUTPUT_LIST;
	}
